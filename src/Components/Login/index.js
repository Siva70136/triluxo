...
const Login = (props) => {
    ...
    const getData = async (e) => {
        ...
        let s=false;
        const res=result.find(each=>{
            if(each.email===userId){
            ...
            <div className="app-container">
                <div>
                    <form id="addUserForm" className="form">
                        ...
                        <input type="text" name="" id="name" value={userId} className="form-control input" placeholder="Email OR Phone" onChange={e=>setUid(e.target.value)} required />

                        <p className='left'>Password</p>
                        <input type="password" name="" id="PWD" value={pwd}  className="form-control input" placeholder="Password" onChange={e=>setPwd(e.target.value)} required />
                        <p id="emailErrMsg"></p>


                        <div className="button-container">
                            <button className="button" type='submit' onClick={getData}>submit</button>
                        </div>

                    </form>

                    <p className=" m-auto">Don't have an account?<Link to="/signup" className="signup">Sign UP</Link></p>
                    <div className="icons">
